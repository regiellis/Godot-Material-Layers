...
- <img align="absmiddle" width="20" height="20" alt="maskMaterial_32x32" src="https://github.com/user-attachments/assets/5253218e-fb3f-4aca-ae5e-ff152722733d" />**`MaskMaterial`**: Material used to blend SurfaceMaterials. You write your own blending logic such as height blending, vertex colors or sample textures. You control how each attribute is blended.
